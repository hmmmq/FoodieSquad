...
INSERT INTO `cart` VALUES (4,NULL),(50,NULL),(101,NULL),(102,NULL),(10101,NULL);
...
INSERT INTO `favorite` VALUES (4,4),(101,101),(102,102),(10101,10101);
...
INSERT INTO `permission` VALUES (0,'进入注册','ROLE_EREGISTER'),(1,'进入用户端','ROLE_EUSER'),(2,'进入骑手端','ROLE_EDRIVER'),(3,'进入商家端','ROLE_EWINDOW'),(4,'进入管理员端','ROLE_EADMIN');
...
INSERT INTO `role` VALUES (0,'新用户','新用户'),(1,'普通用户','普通用户'),(2,'骑手','骑手'),(3,'商家','商家'),(4,'管理员','管理员');
...
INSERT INTO `role_permission` VALUES (0,0),(1,1),(2,1),(2,2),(3,3),(4,1),(4,2),(4,4);
...
CREATE TABLE `user` (
  ...
  `accountNonExpired` int(5) DEFAULT '1',
  `accountNonLocked` int(5) DEFAULT '1',
  `enabled` int(5) DEFAULT '1',
  `credentialsNonExpired` int(5) DEFAULT '1',
  PRIMARY KEY (`user_id`)
...
INSERT INTO `user` VALUES (0,'newuser','新用户','$2a$10$j4Wf1JI4ahJUtrrPW7srvu2iskgkPe1xWRgAxayrJSnInpfzxC2Ky','m',0.00,1,NULL,NULL,NULL,NULL,'newuser','$2a$10$j4Wf1JI4ahJUtrrPW7srvu2iskgkPe1xWRgAxayrJSnInpfzxC2Ky',1,1,1,1),(4,'20181620310008','hmq','$2a$10$XMOWKSRYwr5/4mqnX.IAH.i8iJyk5zbDiU.NyZeaUP.WEfXVcfCkq','f',100.00,0,NULL,4,4,NULL,'20181620310008','$2a$10$XMOWKSRYwr5/4mqnX.IAH.i8iJyk5zbDiU.NyZeaUP.WEfXVcfCkq',1,1,1,1),(50,'2012839899001','管理员2','$2a$10$dbARcVNUKKWNyE.T/yzxiO5eBX9VjQWie8eKhylHeEzMCCYLNbTNe','m',0.00,3,NULL,50,50,NULL,'2012839899001','$2a$10$dbARcVNUKKWNyE.T/yzxiO5eBX9VjQWie8eKhylHeEzMCCYLNbTNe',1,1,1,1),(101,'2012839899003','快递员','$2a$10$MuAzTh59dXq3OPVwkTdPHuzsD7K.mPodQ442lhRswGq/qeAj5aQPu','m',0.00,1,NULL,101,101,NULL,'2012839899003','$2a$10$MuAzTh59dXq3OPVwkTdPHuzsD7K.mPodQ442lhRswGq/qeAj5aQPu',1,1,1,1),(102,'2012839899004','快递员','$2a$10$RNWyw135FlHNTvNYesXxJeuLgf4a.ZHkyKd5K.MZPKkVK5mwg5dES','m',0.00,1,NULL,102,102,NULL,'2012839899004','$2a$10$RNWyw135FlHNTvNYesXxJeuLgf4a.ZHkyKd5K.MZPKkVK5mwg5dES',1,1,1,1),(10101,'10101','10101','$2a$10$nU4Vyru52gzPcrS6xLIHSOBDAfb/z04UKWuV8RdjtIiPp1DIPk1Ca','m',0.00,2,NULL,10101,10101,NULL,'10101','$2a$10$nU4Vyru52gzPcrS6xLIHSOBDAfb/z04UKWuV8RdjtIiPp1DIPk1Ca',1,1,1,1);
...
INSERT INTO `user_address` VALUES (401,'hnu',4),(5001,'home1',50),(5002,'home2',50),(10101,'address1',101),(10102,'address2',101),(10201,'address11',102),(10202,'address12',102),(1010101,'windowaddress11',10101),(1010102,'windowaddress12',10101);
...
INSERT INTO `user_role` VALUES (0,0),(4,1),(50,4),(101,2),(102,2),(10101,3);
...
INSERT INTO `user_tele` VALUES ('13714186980',4,401),('13714186201',50,5001),('13714186202',50,5002),('13714186291',101,10101),('13714186292',101,10102),('13714186281',102,10201),('13714186282',102,10202),('13714186271',10101,1010101),('13714186272',10101,1010102);
...
-- Dump completed on 2020-06-17 21:46:30
