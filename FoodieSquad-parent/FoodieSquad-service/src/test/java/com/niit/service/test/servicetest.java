...
//	for(int i=1;i<9;i++)
//userService.deleteByPrimaryKey(39);
	
 List<UserTele> userTelelist=new ArrayList<UserTele>();
 List<UserAddress> userAddress=new ArrayList<UserAddress>();
for(int i=1;i<3;i++)
    userTelelist.add(new UserTele(null,"1371418620"+i));
 for(int i=1;i<3;i++)
	userAddress.add(new UserAddress(null,"home"+i)) ;
 BigDecimal big=new BigDecimal("0");
//User record=new User(10101,null, "商家10101","123", userTelelist,"m", userAddress,big, 2);

//User record=new User("2012839899001", "快递员","123", userTelelist,"m", userAddress,big, 1);
