...
<c:set value="${pageContext.request.contextPath}/image/riderTypeCaptchaPage/" var="imgpth" scope="page"/>
...
<link rel="stylesheet" type="text/css" href="${csspth}cssForRiderTypeCaptchaPage.css">
<script>
$(document).ready(
	    function(){
