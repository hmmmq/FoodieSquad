...
<!-- 标题组头部 -->
<div class="bg_1 text_title "><!-- 返回符号.svg--><img id="img1" src="${imgpth}return.svg" onclick="window.location.href='${pageContext.request.contextPath}/home/test.do'"><!--选择餐厅label--><label id="xzct" >选择餐厅</label></div>
