...
<div class="container">
<!--顶部页面属性与后退-->
<div class="headingBox"><img src="${imgpth}returnbutton.svg" id="returnbtn" class="closeButtonSize" onclick="window.location.href='${pageContext.request.contextPath}/home/test.do'"/><label for="returnbtn" class="headingText">错误页面</label>
</div>
<!--logo图片-->
<div class="logoBox">
...
<c:choose> 
	...
	<p class="infoText">${exc}</p>
     ...
     <c:otherwise> 
<p class="infoText">403 authentication not attempted </p>
  </c:otherwise> 
...
<div class="addtionBox">
    <p class="additionText" onclick="call()" >抱歉，您当前没有访问权限，请登录！<br/><b onclick="javascript:history.back(-1);">请返回上一级页面</b></p>
</div>
</div>
</body>
</html>