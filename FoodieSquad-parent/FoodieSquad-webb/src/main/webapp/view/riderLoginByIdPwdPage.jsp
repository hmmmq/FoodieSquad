...
<head>
    ...
    <c:set value="${pageContext.request.contextPath}/image/riderLoginByIdPwdPage/" var="imgpth" scope="page"/>
    ...
    <link rel="stylesheet" type="text/css" href="${csspth}cssForRiderLoginByIdPwdPage.css"/>
