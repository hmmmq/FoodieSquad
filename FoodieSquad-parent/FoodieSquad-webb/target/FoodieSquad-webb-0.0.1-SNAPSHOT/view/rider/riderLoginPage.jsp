...
<c:set value="${pageContext.request.contextPath}/image/riderLoginPage/" var="imgpth" scope="page"/>
...
<link rel="stylesheet" type="text/css" href="${csspth}cssForRiderLoginPage.css">
</head>
<body>
<!--容器-->
<div class="container">
<!--顶部页面属性与后退-->
<div class="headingBox"><img src="${imgpth}closebutton.svg" id="closebtn" class="closeButtonSize"/><label for="closebtn" class="headingText">欢迎注册大妈骑手</label>
</div>
<!--logo图片-->
<div class="logoBox">
...
<div class="addtionBox">
    <p class="additionText" onclick="call()" ><span style="background: rgba(255,170,1,0.8);font-size:20px;border:1px solid 	#D0D0D0;border-radius: 15px;padding:5px 100px;cursor: pointer; color: #ffffff;"><b>登录</b></span><br/><br/>登录/注册即代表同意<b>服务协议</b></p>
</div>
</div>
