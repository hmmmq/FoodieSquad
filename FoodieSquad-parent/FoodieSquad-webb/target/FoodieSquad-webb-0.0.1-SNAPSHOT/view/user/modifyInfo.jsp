...
<div class="container" style="background-repeat:no-repeat; background-size:100% auto;-moz-background-size:100% auto;">
    ...
    <form action="modify.do" method="post" id="ff">
        ...
        <div class="addressInfoRow">
            ...
            <input type="password" value="${userpassword}" id="userpassword" name="userpassword" class="column2">
        </div>
        <div class="separateLine"></div>
        </form>
    </div>
    <div class="clickBox">
        ...
        <button class="logOutBtn" onclick="window.location.href='${pageContext.request.contextPath}/personalCenter/logout.do'">退出账号</button>
    </div>
</div>
<script>
