...
<!--个人中心-->
<div class="personalcenter col-md-6" style="list-style: none; width: 100px; height: 100px;" 
onclick="window.location.href='${pageContext.request.contextPath}/personalCenter/test.do'"> <span style="padding-top: 4px"> <img src="${imgpth}logo.svg"><br><p style="margin-top: 18px">个人中心</p> </span> </div>
</div>
</div>
