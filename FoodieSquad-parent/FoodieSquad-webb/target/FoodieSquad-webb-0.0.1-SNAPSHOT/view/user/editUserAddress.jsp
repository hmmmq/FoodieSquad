...
<div class="container" style="background-repeat:no-repeat; background-size:100% auto;-moz-background-size:100% auto;">
    ...
    <div class="topBox" >
        ...
        <span class="addAddressField">编辑地址</span>
    ...
    <form action="editAddress.do" method="post" id="ff">
        ...
        <div class="addressInfoRow">
            ...
            <input type="text" value="${tele}" class="column2" id="userphone" name="userphone">
        </div>
        <div class="separateLine"></div>
        <div class="addressInfoRow">
            <span class="column1">送餐地址</span>
            <input type="text" value="${address}" class="column2" id="address" name="address">
        </div>
        <div class="separateLine"></div>
        <input type="hidden" id="teleId" name="teleId" value="${teleId}"/><input type="hidden" id="addressId" name="addressId" value="${addressId}"/>
    </form>
    </div>
